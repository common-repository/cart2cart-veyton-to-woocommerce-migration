 ...
 */
/*
Plugin Name: Cart2Cart: xt:Commerce Veyton to WooCommerce Migration Module
...
function cart2cart_config(){
	...
	$sourceCartName = 'xt:Commerce Veyton';
  $sourceCartId = 'XtcommerceVeyton';
  $sourceCartUrl = 'xt-commerce-veyton';
